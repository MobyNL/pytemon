...
POKEMON: dict[int, SpeciesData] = {
    ...
    # Machop family — Rock Tunnel wild encounter + trade-evolver chain
    66: SpeciesData(
        name="MACHOP",
        number=66,
        types=[FIGHTING],
    ...
    # Gastly family — Ghost type; trade-evolver chain
    92: SpeciesData(
        name="GASTLY",
        number=92,
        types=[GHOST, POISON],
    ...
    # Diglett family — Ground type; Diglett's Cave residents
    50: SpeciesData(
        name="DIGLETT",
        number=50,
        types=[GROUND],
    ...
    # Cubone family — Ground type; Pokemon Tower residents
    104: SpeciesData(
        name="CUBONE",
        number=104,
        types=[GROUND],
